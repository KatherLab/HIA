...
def ClamMILTraining(args):
    ...
    for targetLabel in targetLabels:
        ...
        if args.feature_extract:
            ...
            ExtractFeatures(data_dir = imgs, feat_dir = args.feat_dir[0], batch_size = args.batch_size, target_patch_size = -1, filterData = True)
        ...
        if args.train_full:
            dataset.Create_splits(k = 1, val_num = [0, 0], test_num = [0,0], label_frac = lf)
            for i in range(1):
                dataset.Set_splits()
